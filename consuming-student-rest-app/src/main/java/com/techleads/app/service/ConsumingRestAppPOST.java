...
//@Component
public class ConsumingRestAppPOST implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		st.setCourse("English");
		st.setName("Nisha");
		st.setFees(1200D);

		HttpEntity<Student> httpEntity = new HttpEntity<>(st, headers);

		ResponseEntity<Student> exchnage = restTemplate.exchange(url, HttpMethod.POST, httpEntity, studentPTR);
